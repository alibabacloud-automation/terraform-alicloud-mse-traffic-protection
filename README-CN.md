阿里云 MSE 全方位流量防护 Terraform 模块

# terraform-alicloud-mse-traffic-protection

[English](https://github.com/alibabacloud-automation/terraform-alicloud-mse-traffic-protection/blob/main/README.md) | 简体中文

在阿里云上使用微服务引擎（MSE）实现全方位流量防护的 Terraform 模块。此模块旨在帮助用户部署和配置基于 MSE 的流量防护解决方案，为其应用程序提供流量治理、服务发现和配置管理等功能。有关解决方案的更多信息，请参考 [MSE 助力实现全方位流量防护](https://www.aliyun.com/solution/tech-solution/use-mse-to-implement-comprehensive-traffic-protection)。

## 使用方法

要使用此模块实现 MSE 全方位流量防护，您需要提供 MSE License Key 并配置基础设施，包括 VPC、ECS 实例和相关资源。
...
* [完整示例](https://github.com/alibabacloud-automation/terraform-alicloud-mse-traffic-protection/tree/main/examples/complete)
